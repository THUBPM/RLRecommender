...
def main():
    ...
    parser.add_argument('--data_dir', type=str, default='../data/causal_big/')
    ...
    parser.add_argument('--log_file', type=str, default='../log/log_causal_big.txt')
    ...
    with tf.Session(config=sess_config) as sess:
        ...
        for epoch in range(args.max_epoch):
            ...
            saver.save(sess, '../ckpt/causal_big.ckpt', global_step=epoch + 1)
