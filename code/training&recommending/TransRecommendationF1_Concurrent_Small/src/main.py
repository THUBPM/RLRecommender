...
def main():
    ...
    parser.add_argument('--data_dir', type=str, default='../data/concurrent_small/')
    ...
    parser.add_argument('--log_file', type=str, default='../log/log_concurrent_small.txt')
    ...
    with tf.Session(config=sess_config) as sess:
        ...
        for epoch in range(args.max_epoch):
            ...
            saver.save(sess, '../ckpt/concurrent_small.ckpt', global_step=epoch + 1)
